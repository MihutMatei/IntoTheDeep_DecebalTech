...
//
//@Autonomous(name="SpecimeneAlbastru'", group="AUTONOMOUSGOOD")
//@Config
//
//public class SpecimeneAlbastru extends LinearOpMode {
//
//
...
//                .lineToLinearHeading(new Pose2d(44 ,-41,Math.toRadians(-130)))
//
//                .addTemporalMarker(0.01, ()->{
...
//                .lineToLinearHeading(new Pose2d(0,-24.5,Math.toRadians(90)))
//
//                .addTemporalMarker(0.01, ()->{
...
//
//                .setReversed(true)
//                .splineToSplineHeading(new Pose2d(39.3,-52,Math.toRadians(-90)),Math.toRadians(-90))
//                .lineToLinearHeading(new Pose2d(39.3,-60.5,Math.toRadians(-90)))
//
//
//                .addTemporalMarker(10, ()->{
//
...
//                })
//                .setReversed(true)
//                .splineToSplineHeading(new Pose2d(39.8 ,-52,Math.toRadians(-90)),Math.toRadians(-90))
//                .lineToLinearHeading(new Pose2d(39.8,-60,Math.toRadians(-90)))
//
//
//                .addTemporalMarker(10, ()->{
//
